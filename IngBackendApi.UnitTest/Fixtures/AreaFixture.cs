...
public class AreaFixture
{
    ...
    public AreaFixture()
    {
        ...
        Fixture.Customize<Area>(c =>
            c.With(p => p.Id, Guid.Empty)
        ...
        Fixture.Customize<AreaType>(c =>
            c.With(p => p.Name, Fixture.Create<string>())
        ...
        Fixture.Customize<TextLayout>(c =>
            c.With(p => p.Id, Guid.Empty)
        ...
        Fixture.Customize<ImageTextLayout>(c =>
            c.With(p => p.Id, Guid.Empty)
        ...
        Fixture.Customize<ListLayout>(c =>
            c.With(p => p.Id, Guid.Empty)
        ...
        Fixture.Customize<KeyValueListLayout>(c =>
            c.With(p => p.Id, Guid.Empty)
        ...
        Fixture.Customize<KeyValueItem>(c =>
            c.With(p => p.Id, Guid.Empty)
                .With(p => p.Key, Fixture.Create<List<Tag>>())
                .With(p => p.Value, Fixture.Create<string>())
        );
        #endregion

        #region  Customize DTOs
        Fixture.Customize<AreaDTO>(c =>
            c.With(p => p.Id, Guid.Empty)
                .With(p => p.Sequence, Fixture.Create<int>())
                .With(p => p.IsDisplayed, Fixture.Create<bool>())
                .With(p => p.Title, Fixture.Create<string>())
        ...
        Fixture.Customize<AreaPostDTO>(c =>
            c.With(p => p.Id, Fixture.Create<Guid?>())
                .With(p => p.Sequence, Fixture.Create<int>())
                .With(p => p.IsDisplayed, Fixture.Create<bool>())
                .With(p => p.Title, Fixture.Create<string>())
                .With(p => p.LayoutType, Fixture.Create<LayoutType?>())
        ...
        Fixture.Customize<AreaTypeDTO>(c =>
            c.With(p => p.Name, Fixture.Create<string>())
                .With(p => p.Value, Fixture.Create<string>())
                .With(p => p.Description, Fixture.Create<string>())
                .With(p => p.UserRole, Fixture.Create<List<UserRole>>())
        ...
        Fixture.Customize<AreaTypePostDTO>(c =>
            c.With(p => p.Name, Fixture.Create<string>())
                .With(p => p.Value, Fixture.Create<string>())
                .With(p => p.Description, Fixture.Create<string>())
                .With(p => p.UserRole, Fixture.Create<List<UserRole>>())
        ...
        Fixture.Customize<AreaFormDataDTO>(c =>
            c.With(p => p.Image, null as IFormFile)
                .With(p => p.AreaPost, Fixture.Create<AreaPostDTO>())
        );
        #endregion

        #region Customize TextLayoutDTO
        Fixture.Customize<TextLayoutDTO>(c =>
            c.With(p => p.Id, Guid.Empty).With(p => p.Content, Fixture.Create<string>())
        );
        #endregion

        #region Customize ImageDTO
        Fixture.Customize<ImageDTO>(c =>
            c.With(p => p.Id, Guid.Empty)
                .With(p => p.Filepath, Fixture.Create<string>())
                .With(p => p.AltContent, Fixture.Create<string>())
                .With(p => p.ContentType, Fixture.Create<string>())
        ...
        Fixture.Customize<ImageTextLayoutDTO>(c =>
            c.With(p => p.Id, Guid.Empty).With(p => p.Image, Fixture.Create<ImageInfo>())
        );
        #endregion

        #region Customize ListLayoutDTO
        Fixture.Customize<ListLayoutDTO>(c =>
            c.With(p => p.Id, Fixture.Create<Guid?>())
        ...
        Fixture.Customize<ListLayoutPostDTO>(c =>
            c.With(p => p.Items, Fixture.Create<List<TagPostDTO>>())
        );
        #endregion

        #region Customize KeyValueListLayoutDTO
        Fixture.Customize<KeyValueListLayoutDTO>(c =>
            c.With(p => p.Id, Guid.Empty)
        ...
        Fixture.Customize<KeyValueItemDTO>(c =>
            c.With(p => p.Id, Guid.Empty)
                .With(p => p.Key, Fixture.Create<List<TagDTO>>())
                .With(p => p.Value, Fixture.Create<string>())
        );
        #endregion
    }
